    ...
    <NavbarContainer className={isScrolled ? "scrolled" : ""}>
      <NavbarContent>
        ...
        <NavbarMenu isOpen={isMenuOpen}>
          <NavbarItem>
            <NavbarLink href="#">À propos</NavbarLink>
          </NavbarItem>
          <NavbarItem>
            <NavbarLink href="/candidature-stage">Candidature Stage</NavbarLink>
          </NavbarItem>
          <NavbarItem>
            <NavbarLink href="/plus-information">Plus informations</NavbarLink>
          </NavbarItem>
          <NavbarItem>
        ...
        <div className="desktop-buttons" style={{ display: "flex", alignItems: "center" }}>
          <SearchButton>
            <FaSearch />
          </SearchButton>
          <NavbarButtons>
            {/* <Button className="btn-register" onClick={() => navigate("/Inscription")} >
              <FaUserCircle /> Inscription
            </Button> */}
